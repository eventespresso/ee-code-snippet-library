...
add_action('AHEE__Single_Page_Checkout__after_attendee_information__process_reg_step', 'ee_spco_change_line_item_before_payment_options_step', 10, 1);
function ee_spco_change_line_item_before_payment_options_step(EE_SPCO_Reg_Step_Attendee_Information $data)
{
